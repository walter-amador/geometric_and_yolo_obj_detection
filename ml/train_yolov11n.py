...
def train_yolov11n(config):
    """
    Fine-tune YOLOv11n model on custom dataset

    Args:
        config: Dictionary containing training configuration
    """
    print("\n" + "=" * 60)
    print("🚀 Starting YOLOv11n Fine-tuning")
    print("=" * 60)
...
def main():
    ...
    """
    print("\n" + "=" * 60)
    print("🤖 YOLOv11n Fine-tuning for Traffic Sign Detection")
    print("=" * 60)

    # Train the model
    results = train_yolov11n(CONFIG)
